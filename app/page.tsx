  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <Card className="border-0 shadow-none bg-transparent dark:bg-transparent">
        <CardContent className="p-0">{renderComponent()}</CardContent>
      </Card>
...
function FunctionCard({
  ...
  return (
    <div
      className="function-card border rounded-lg p-6 hover:border-teal-300 hover:shadow-md transition-all cursor-pointer bg-white dark:bg-gray-800 dark:border-gray-700"
      onClick={onClick}
    >
      <div className="flex flex-col items-center text-center">
        <div className="icon-container mb-4 p-3 bg-gray-50 rounded-full dark:bg-gray-700">{icon}</div>
