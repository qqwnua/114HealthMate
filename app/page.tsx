...
export default function Home() {
  ...
  const handleBackToMain = () => setActiveComponent(null)
...
// 功能卡片組件
function FunctionCard({ icon, title, description, onClick }: { icon: React.ReactNode, title: string, description: string, onClick: () => void }) {
  return (
    <div
